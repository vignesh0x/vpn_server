...
WireGuard uses a **public/private key pair** — like a lock and key. You generate these on the server first.
...
To view your keys:
```bash
cat privatekey   # Your private key — NEVER share this!
cat publickey    # Your public key — safe to share
```

> ⚠️ **Important:** Your private key is like a password. Never share it with anyone, ever.
...
cat publickey   # Copy this — you'll need it for the server config (Step 5)
```
...
> Made with ❤️ — Feel free to fork and improve this guide!
